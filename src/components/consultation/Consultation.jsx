...
const Consultation = () => {
  return (
    <section className="w-full flex flex-col items-center justify-center">
      ...
      <main className="w-[90%] xl:w-[80%] space-y-8 md:space-y-0 flex flex-col md:flex-row md:justify-between md:items-center my-20 text-white p-4 py-6 text-justify rounded-lg shadow-lg bg-black/20 backdrop-blur-md border border-white/30">
        <div
